            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    if (data.success){
                        ...
                        html += 'nbsp;&nbsp;&nbsp;&nbsp;';
                        html += '<a class="myHref" id="'+data.remark.id+'" href="javascript:void(0);" onclick="deleteRemark(\''+data.remark.id+'\')"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #FF0000;"></span></a>';
                        html += '</div>';
                        html += '</div>';
                        html += '</div>';
            ...
            $.ajax({
                ...
                success:function (data) {
                    if (data.success){
                        ...
                        $("#s"+id).html(data.remark.editBy+' 由'+data.remark.editTime);
