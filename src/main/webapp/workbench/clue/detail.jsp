...
<script type="text/javascript">
            ...
            $.ajax({
                ...
                success:function (data) {
                    if (data.success){
                        ...
                        html +='<img title="'+data.remark.createBy+'" src="image/user-thumbnail.png" style="width: 30px; height:30px;">'
                        html +='<div style="position: relative; top: -40px; left: 40px;" >'
                        html +='<h5>'+data.remark.noteContent+'</h5>'
                        html +='<font color="gray">线索</font> <font color="gray">-</font> <b>${clue.fullname}${clue.appellation}-${clue.company}</b> <small style="color: gray;"> '+data.remark.createTime+' 由'+data.remark.createBy+'</small>'
	...
	function getClueRemarkList() {
        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                $("#activityBundBody").on("click",$("input[name=xz]"),function () {
    ...
    function getBundList() {
        $.ajax({
            url:"workbench/clue/getBundList.do",
            data:{
                "clueId":"${clue.id}"
            },
            type:"get",
