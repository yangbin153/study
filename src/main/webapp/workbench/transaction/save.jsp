...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#saveBtn").click(function () {
            if ($.trim($("#create-owner").val())==""||$.trim($("#create-name").val())==""
...
<body>
	...
	<form class="form-horizontal" role="form" action="workbench/tran/saveTran.do" style="position: relative; top: -30px;" id="saveTranForm" method="post">
