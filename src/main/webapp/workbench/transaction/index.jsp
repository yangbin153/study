...
<script type="text/javascript">
	...
	$(function(){
	    ...
	    $("#searchBtn").click(function () {
            tranPageList(1,$("#tranPage").bs_pagination('getOption', 'rowsPerPage'));
	...
	function tranPageList(pageNo,pageSize){
        $.ajax({
            url:"workbench/tran/getTranList.do",
            data:{
                "pageNoStr":pageNo,
            ...
            success:function (data) {
                ...
                $("#tranPage").bs_pagination({
                    ...
                    onChangePage : function(event, data){
                        tranPageList(data.currentPage , data.rowsPerPage);
                    }
                });
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="height: 80px;">
				<form class="form-inline" id="tranSearchForm" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <button type="searchBtn" class="btn btn-default">查询</button>
				  
				</form>
			</div>
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 10px;">
				<div class="btn-group" style="position: relative; top: 18%;">
				  <button type="button" class="btn btn-primary" id="createBtn" onclick="window.location.href='workbench/tran/createTran.do';"><span class="glyphicon glyphicon-plus"></span> 创建</button>
